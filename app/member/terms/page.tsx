      ...
      >
        <Box sx={{ px: { xs: 1.5, sm: 2, md: 3 }, py: { xs: 1.25, md: 2 }, flex: 1 }}>
          ...
          <Typography variant="caption" color="text.secondary">
            Review our <Link href="/member/privacy" style={{ textDecoration: "none", fontWeight: 700 }}>Privacy Policy</Link> for data handling details and DPO contact information.
          </Typography>
            </Stack>
          </Container>
        </Box>
